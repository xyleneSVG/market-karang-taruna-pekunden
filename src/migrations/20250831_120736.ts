...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "products_images" ADD CONSTRAINT "products_images_item_id_media_id_fk" FOREIGN KEY ("item_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "products_images_item_idx" ON "products_images" USING btree ("item_id");

              ...
              <div className="flex items-start justify-between">
                ...
                <div className="flex items-center gap-2">
                  <Button
                    ...
                    className={`transition-all duration-300 hover:scale-125 ${isLiked ? 'text-red-500' : ''}`}
                  >
                    <Heart
                      className={`w-5 h-5 transition-all duration-300 ${isLiked ? 'fill-current scale-125' : ''}`}
                    />
                  </Button>
                  <Button
                    variant="ghost"
